...
const xidanZone: ExplorationZone = {
  ...
  routeGeo: [
    ...
    { latitude: 39.9099772968, longitude: 116.3670070808 },
  ],
  mapRoutePoints: [{ x: 262.9, y: 280 }, { x: 400.8, y: 202.3 }],
  svgPath: "M262.9 280 L400.8 202.3",
  ...
  checkpoints: [{
    ...
    giftType: "sparkle",
    location: { latitude: 39.9099772968, longitude: 116.3670070808 },
    unlockRadiusM: 55,
